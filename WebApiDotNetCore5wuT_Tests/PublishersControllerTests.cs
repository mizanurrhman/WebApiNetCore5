...
using WebApiDotNetCoreWithUnitTest.Controllers;
...
namespace WebApiDotNetCore5wuT_Tests
{
    public class PublishersControllerTests
    {
        ...
        public void HTTPGET_GetAllPublishers_WithSortBySearchPageNr_ReturnOk_Test()
        {
            ...
            Assert.That(actionResultData2ndPage.First().Name, Is.EqualTo("Publisher 1"));
            Assert.That(actionResultData2ndPage.First().Id, Is.EqualTo(1));
